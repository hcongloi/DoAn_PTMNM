...
if (isset($_POST['submit'])) {
    ...
    $pattern = '/^[0-9,]+$/';
    if (preg_match($pattern, $ds) && is_numeric($timKiem) && $timKiem >= 0) {
        $mang = explode(",", $ds);
        ...
        $ds = "";
        $ketQua = "Vui lòng nhập một dãy số chứa các số nguyên dương, cách nhau bằng dấu ','.";
    }
}
?>
    ...
    <form method="post" action="">
        <table align="center" style="background-color: #C1CDCD">
            ...
            <tr>
                <td>Mảng: </td>
                <td>
                    <input type="text" name="ketqua" size="30" readonly value="<?php if(isset($ds)) echo $ds; ?>">
                </td>
            </tr>
            <tr>
