    ...
    <form method="post" action=>
        <table align="center">
            ...
            <tr style="background-color: pink">
                <td>Nhập dãy số: </td>
                <td>
                    <input type="text" name="ds" size="20" required value="<?php if(isset($ds)) echo $ds; ?>">
                </td>
            </tr>
            <tr style="background-color: pink">
                <td>Giá trị cần thay thế: </td>
                <td>
                    <input type="text" name="valueToReplace" required value="<?php if(isset($valueToReplace)) echo $valueToReplace; ?>">
                </td>
            </tr>
            <tr style="background-color: pink">
                <td>Giá trị thay thế: </td>
                <td>
                    <input type="text" name="replacementValue" required value="<?php if(isset($replacementValue)) echo $replacementValue; ?>">
                </td>
            </tr>
            <tr>
                <td></td>
