...
<body>
  ...
  echo
  "<div class='nut'>
    <a class='them' href='bt2.11_formthem.php'>Thêm mới</a>
  </div>";
  ...
  //gắn thêm nút Back
  if ($_GET['page'] > 1) {
    echo "<a class='phantrang' href=" . $_SERVER['PHP_SELF'] . "?page=" . (1) . ">&#60&#60</a> ";
    echo "<a class='phantrang' href=" . $_SERVER['PHP_SELF'] . "?page=" . ($_GET['page'] - 1) . ">&#60</a> ";
  }
  for ($i = 1; $i <= $maxPage; $i++) //tạo link tương ứng tới các trang
  {
    if ($i == $_GET['page'])
      ...
      echo "<a class='phantrang' href="
        . $_SERVER['PHP_SELF'] . "?page=" . $i . ">" . $i . "</a> ";
  }
  //gắn thêm nút Next
  if ($_GET['page'] < $maxPage) {
    echo "<a class='phantrang' href = " . $_SERVER['PHP_SELF'] . "?page=" . ($_GET['page'] + 1) . ">&#62</a>";
    echo "<a class='phantrang' href = " . $_SERVER['PHP_SELF'] . "?page=" . ($maxPage) . ">&#62&#62</a>";
  }
  echo "</p>";
