...
<body>
    ...
    <form name="karaoke" method="post" action="">
        <table style="background: aquamarine;" align="center">
            <tr>
                <th colspan="2" style="background:cadetblue; color: beige;">
                    TÍNH TIỀN KARAOKE
                </th>
            </tr>
            <tr>
                <td>Giờ bắt đầu:</td>
                <td>
                    <input type="time" name="startTime" size="20" value="<?php
            ...
            <tr>
                <td>Giờ kết thúc:</td>
                <td>
                    <input type="time" name="endTime" size="20" value="<?php
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="paymentBill" size="9" readonly style="background-color: darkgoldenrod;" value="<?php
