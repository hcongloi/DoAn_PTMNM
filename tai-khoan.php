...
if (mysqli_num_rows($result) > 0) {
    ...
    // Nếu không tìm thấy thông tin tài khoản, xử lý theo ý của bạn (ví dụ: hiển thị thông báo lỗi)
    // ...
...
if (isset($_POST['submit'])) {
    ...
    $updateSql = "UPDATE taikhoan SET ho_ten = '$hoTenMoi', email = '$emailMoi', sdt = '$sdtMoi', dia_chi = '$diaChiMoi', mat_khau = '$matKhauMoi', ngay_sinh = '$ngaySinhMoi', gioi_tinh = '$gioiTinhMoi' WHERE ten_tai_khoan = '$tenTaiKhoan'";
...
?>
    ...
    <form class ="form-1" method="POST" action="">
        ...
        <input type="text" id="tenTaiKhoan" name="tenTaiKhoan" value="<?php echo $tenTaiKhoan; ?>"><br>

        <label for="matKhau">Mật khẩu:</label>
        <input type="password" id="matKhau" name="matKhau" value="<?php echo $matKhau; ?>"><br>
